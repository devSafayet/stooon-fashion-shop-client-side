        ...
        <div className='flex h-screen justify-center items-center'>
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex flex-col w-full border-opacity-50 mt-3">
                            ...
                            <p className='m-3'>You are new User?
                                <span><Link to="/register" className='ps-1 text-error text-sm cursor-pointer'>Create New Account</Link></span></p>
                    ...
                    <button onClick={() => signInWithGoogle()} className='btn btn-outline hover:bg-orange-400'><span><img src={google} alt="" /></span> CONTINUE WITH GOOGLE</button>
                </div>
            </div>
        </div>
    );
