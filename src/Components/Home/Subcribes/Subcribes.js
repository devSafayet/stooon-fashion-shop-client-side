...
const Subcribes = () => {
    return (
        <div className='bg-base-300 m-12 text-center' style={{ backgroundColor: "#A6A6A6" }}>
            <h1 className='pt-12 pb-6 text-4xl font-semibold text-white'>KEEP CONNECTED</h1>
            ...
            <div class="form-control ">
                <div class="input-group justify-center pt-5 pb-12">
                    <input type="text" placeholder="Enter Address" class="input input-bordered pr-10 pl-10" />
